// src/pages/PractitionerDashboardPage.tsx
    ...
    <div className="grid gap-6 md:grid-cols-[minmax(0,1.2fr)_minmax(0,1.1fr)]">
      <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-4">
        <h1 className="text-xl font-semibold mb-2">
          Practitioner view{user ? ` – ${user.firstName}` : ''}
        </h1>
        <p className="text-sm text-slate-400 mb-4">
          Review upcoming sessions and associated intake forms.
        </p>
      ...
      <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-4">
        <h2 className="text-sm font-semibold mb-2">Intake & notes</h2>
